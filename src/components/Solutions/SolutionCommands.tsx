				...
				<div className="text-xs text-white/90 backdrop-blur-md bg-black/60 rounded-lg py-2 px-4 flex items-center justify-center gap-4">
					...
					>
						...
						<div className="flex gap-1">
							...
							<button className="bg-white/10 rounded-md px-1.5 py-1 text-[11px] leading-none text-white/70">B</button>
						</div>
					</div>
											...
											>
												<div className="flex items-center justify-between">
													...
													<div className="flex gap-1 flex-shrink-0">
														...
														<span className="bg-white/20 px-1.5 py-0.5 rounded text-[10px] leading-none">B</span>
													</div>
												</div>
													...
													>
														<div className="flex items-center justify-between">
															...
															<div className="flex gap-1 flex-shrink-0">
																...
																<span className="bg-white/20 px-1.5 py-0.5 rounded text-[10px] leading-none">H</span>
															</div>
														</div>
														<p className="text-[10px] leading-relaxed text-white/70 truncate mt-1">
														...
														>
															<div className="flex items-center justify-between">
																...
																<div className="flex gap-1 flex-shrink-0">
																	...
																	<span className="bg-white/20 px-1.5 py-0.5 rounded text-[10px] leading-none">↵</span>
																</div>
															</div>
															<p className="text-[10px] leading-relaxed text-white/70 truncate mt-1">
											...
											>
												<div className="flex items-center justify-between">
													...
													<div className="flex gap-1 flex-shrink-0">
														...
														<span className="bg-white/20 px-1.5 py-0.5 rounded text-[10px] leading-none">R</span>
													</div>
												</div>
												<p className="text-[10px] leading-relaxed text-white/70 truncate mt-1">
